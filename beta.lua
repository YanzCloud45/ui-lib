local Library = {
    ...
    Theme = {
        ...
        Container = Color3.fromRGB(25, 25, 28),
...
function Utility:CreateRipple(parent)
    ...
    -- Memanfaatkan AbsoluteSize untuk kalkulasi ripple radius
...
function Library:Notify(config)
    ...
    notif.Size = UDim2.new(1, 0, 0, 0) -- Mulai dari 0 untuk animasi slide in
    ...
    Utility:Tween(notif, {Size = UDim2.new(1, 0, 0, 60)}, 0.4, Enum.EasingStyle.Back)
...
function Library:CreateWindow(config)
    config = config or {}
    local WindowTitle = config.Title or "Premium UI Hub"
    ...
    ScreenGui.Name = "PremiumLibraryGUI"
    ...
    -- UIGradient untuk background glassmorphism / premium feel
    local MainGradient = Instance.new("UIGradient")
    MainGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Library.Theme.Background),
        ColorSequenceKeypoint.new(1, Library.Theme.Container)
    })
    MainGradient.Rotation = 45
    MainGradient.Parent = Main

    -- Drop Shadow (Menggunakan Image Label)
    ...
    -- Drag Indicator (Garis-garis kecil di tengah)
    local DragIndicator = Instance.new("Frame")
    DragIndicator.Size = UDim2.new(0, 40, 0, 4)
    DragIndicator.Position = UDim2.new(0.5, -20, 0, 8)
    ...
    function WindowAPI:AddTab(tabConfig)
        ...
        local tabIcon = tabConfig.Icon or "✦" -- Unicode default
        ...
        -- Garis vertikal indikator active tab
        ...
        TabBtn.MouseButton1Click:Connect(function()
            ...
            Utility:Tween(TabTitle, {TextColor3 = Library.Theme.Text}, 0.2)
            Utility:Tween(TabIndicator, {Size = UDim2.new(0, 3, 0, 24)}, 0.2)
        end)
        ...
        function TabAPI:AddToggle(tConfig)
            ...
            circle.Position = ToggleAPI.Value and UDim2.new(1, -21, 0.5, -9) or UDim2.new(0, 3, 0.5, -9)
            ...
            local function UpdateVisuals()
                local tPos = ToggleAPI.Value and UDim2.new(1, -21, 0.5, -9) or UDim2.new(0, 3, 0.5, -9)
                local tCol = ToggleAPI.Value and Library.Theme.Accent or Library.Theme.Container
                Utility:Tween(circle, {Position = tPos}, 0.25, Enum.EasingStyle.Back)
        ...
        function TabAPI:AddSlider(sConfig)
            ...
            barBtn.Position = UDim2.new(0, 15, 0, 32)
            ...
            thumbShadow.ImageTransparency = 0.4
            thumbShadow.Size = UDim2.new(1, 14, 1, 14)
            thumbShadow.Position = UDim2.new(0, -7, 0, -7)
        ...
        function TabAPI:AddButton(bConfig)
            ...
            btn.MouseButton1Down:Connect(function()
                Utility:Tween(btn, {Size = UDim2.new(1, -4, 0, 38)}, 0.1)
            end)
            btn.MouseButton1Up:Connect(function()
                Utility:Tween(btn, {Size = UDim2.new(1, 0, 0, 42)}, 0.1)
            end)
        ...
        function TabAPI:AddDropdown(dConfig)
            ...
            function DropdownAPI:Toggle()
                ...
                if self.IsOpen then
                    ...
                    local targetH = math.clamp(th, 0, 150)
                    OptionContainer.Size = UDim2.new(1, -20, 0, targetH)
                    Utility:Tween(row, {Size = UDim2.new(1, 0, 0, 42 + targetH + 10)}, 0.3, Enum.EasingStyle.Quint)
                    Utility:Tween(icon, {Rotation = 180}, 0.3)
                else
                    Utility:Tween(row, {Size = UDim2.new(1, 0, 0, 42)}, 0.3, Enum.EasingStyle.Quint)
...
--[[
-- ========================================================================
-- EXAMPLE USAGE (MODERN CHAINABLE API)
-- ========================================================================

local Library = require(path.to.this.module)

local Window = Library:CreateWindow({
    Title = "Aztup / Kiriot Premium Style Hub"
})

-- Memanggil Notification
Library:Notify({
    Title = "Welcome",
    Content = "Successfully injected premium script.",
